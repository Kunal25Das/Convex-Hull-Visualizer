...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 px-4 pt-4 pb-0">
            {/* Header */}
            ...
            <div className="flex flex-col lg:flex-row gap-6 max-w-7xl mx-auto">
                ...
                <div className="flex-grow flex justify-center">
                    <div 
                        className="border-2 border-black cursor-crosshair bg-white bg-[url('/grid.png')] bg-cover h-full max-w-2xl aspect-square"
                        onClick={addPoint}
                    >
